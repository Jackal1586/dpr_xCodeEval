...
#def eval_dpr_patk_ratk(eval_matrix: List[List[int]]) -> List:
...
if __name__ == "__main__":
	...
	eval_matrix_out_file = "dpr_eval_matrix_out_140423.json"
	with open(eval_matrix_out_file, "w") as eval_matrix_out_ptr:
		json.dump(eval_matrix, eval_matrix_out_ptr)

	ev = eval_dpr(eval_matrix)

	eval_output_file = "dpr_eval_output_140423.txt"
